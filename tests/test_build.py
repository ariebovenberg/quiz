...
class TestSelectionSet:
            ...
            assert _.foo[_.bar.bing[_.blabla]] == SelectionSet(
                Field(
                    ...
                    selection_set=SelectionSet(
                        Field("bar"),
                        Field(
                            "bing", selection_set=SelectionSet(Field("blabla"))
                        ),
                    ),
                )
            )
    ...
    def test_combination(self):
        assert _.foo.bar[
            _.bing(param1=4.1)
            .baz.foo_bar_bla(p2=None, r="")[_.height(unit="cm")]
            .oof.qux()
        ] == SelectionSet(
            Field("foo"),
            Field(
                ...
                selection_set=SelectionSet(
                    ...
                    Field(
                        "foo_bar_bla",
                        fdict({"p2": None, "r": ""}),
                        SelectionSet(Field("height", fdict({"unit": "cm"}))),
                    ),
                    Field("oof"),
                    Field("qux"),
                ),
...
class TestEscape:
    ...
    def test_fuzzing(self, value):
        assert isinstance(quiz.escape(value), str)
